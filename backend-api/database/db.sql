...
CREATE TABLE actividades_planeadas (
    ...
    meta_trimestral1 DECIMAL(15, 2) NOT NULL DEFAULT 0,
    meta_trimestral2 DECIMAL(15, 2) NOT NULL DEFAULT 0,
    meta_trimestral3 DECIMAL(15, 2) NOT NULL DEFAULT 0,
    meta_trimestral4 DECIMAL(15, 2) NOT NULL DEFAULT 0,
